...
export class DebuggerWorkspaceBinding {
  ...
  constructor(resourceMapping, targetManager) {
    ...
    this.pluginManager = Root.Runtime.experiments.isEnabled("wasmDWARFDebugging") ? new DebuggerLanguagePluginManager(targetManager, resourceMapping.workspace, this) : null;
  }
  initPluginManagerForTest() {
    if (Root.Runtime.experiments.isEnabled("wasmDWARFDebugging")) {
      if (!this.pluginManager) {
        this.pluginManager = new DebuggerLanguagePluginManager(this.#targetManager, this.resourceMapping.workspace, this);
      }
    } else {
  ...
  getCompilerScriptMappingForTest(debuggerModel) {
