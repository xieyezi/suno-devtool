...
((Audits2) => {
  ...
  ((AttributionReportingIssueType2) => {
    ...
    AttributionReportingIssueType2["PermissionPolicyNotDelegated"] = "PermissionPolicyNotDelegated";
    ...
    AttributionReportingIssueType2["InvalidEligibleHeader"] = "InvalidEligibleHeader";
    AttributionReportingIssueType2["TooManyConcurrentRequests"] = "TooManyConcurrentRequests";
  ...
  ((DeprecationIssueType2) => {
    ...
    DeprecationIssueType2["ExpectCTHeader"] = "ExpectCTHeader";
    ...
    DeprecationIssueType2["OverflowVisibleOnReplacedElement"] = "OverflowVisibleOnReplacedElement";
    DeprecationIssueType2["PaymentInstruments"] = "PaymentInstruments";
    DeprecationIssueType2["PaymentRequestCSPViolation"] = "PaymentRequestCSPViolation";
    DeprecationIssueType2["PersistentQuotaType"] = "PersistentQuotaType";
...
((Page2) => {
  ...
  ((BackForwardCacheNotRestoredReason2) => {
    ...
    BackForwardCacheNotRestoredReason2["AuthorizationHeader"] = "AuthorizationHeader";
  ...
  ((PrerenderFinalStatus2) => {
    ...
    PrerenderFinalStatus2["FailToGetMemoryUsage"] = "FailToGetMemoryUsage";
    PrerenderFinalStatus2["DataSaverEnabled"] = "DataSaverEnabled";
    PrerenderFinalStatus2["HasEffectiveUrl"] = "HasEffectiveUrl";
    ...
    PrerenderFinalStatus2["CrossSiteRedirect"] = "CrossSiteRedirect";
    PrerenderFinalStatus2["CrossSiteNavigation"] = "CrossSiteNavigation";
    PrerenderFinalStatus2["SameSiteCrossOriginRedirect"] = "SameSiteCrossOriginRedirect";
    PrerenderFinalStatus2["SameSiteCrossOriginNavigation"] = "SameSiteCrossOriginNavigation";
    PrerenderFinalStatus2["SameSiteCrossOriginRedirectNotOptIn"] = "SameSiteCrossOriginRedirectNotOptIn";
    PrerenderFinalStatus2["SameSiteCrossOriginNavigationNotOptIn"] = "SameSiteCrossOriginNavigationNotOptIn";
