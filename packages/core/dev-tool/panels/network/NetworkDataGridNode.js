...
export class NetworkNode extends DataGrid.SortableDataGrid.SortableDataGridNode {
  ...
  backgroundColor() {
    ...
    const isSelected = this.dataGrid && (this.dataGrid.element === document.activeElement || this.dataGrid?.selectedNode?.elementInternal?.firstElementChild === document.activeElement);
...
export class NetworkRequestNode extends NetworkNode {
  ...
  select(supressSelectedEvent) {
    ...
    const selectedElement = this.dataGrid?.selectedNode?.elementInternal?.firstElementChild;
    if (selectedElement) {
  ...
  deselect(suppressSelectedEvent) {
    ...
    const deselectedElement = this.elementInternal?.firstElementChild;
