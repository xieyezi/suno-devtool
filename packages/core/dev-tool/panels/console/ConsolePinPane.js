...
export class ConsolePin {
  ...
  async updatePreview() {
    ...
    const { preview, result } = await ObjectUI.JavaScriptREPL.JavaScriptREPL.evaluateAndBuildPreview(preprocessedExpression, throwOnSideEffect, true, timeout, !isEditing, "console", true, true);
