...
export class WebauthnPaneImpl extends UI.Widget.VBox {
  ...
  async #addAuthenticatorSection(authenticatorId, options) {
    ...
    if (this.#model) {
      this.#model.addEventListener(SDK.WebAuthnModel.Events.CredentialAdded, this.#addCredential.bind(this, authenticatorId));
      this.#model.addEventListener(SDK.WebAuthnModel.Events.CredentialAsserted, this.#updateCredential.bind(this, authenticatorId));
    }
    return section;
  }
