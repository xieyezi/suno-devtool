...
export class UISourceCodeFrame extends Common.ObjectWrapper.eventMixin(SourceFrame.SourceFrame.SourceFrameImpl) {
  ...
  initializeUISourceCode() {
    ...
    if (Root.Runtime.experiments.isEnabled("sourcesPrettyPrint")) {
      ...
      const canPrettyPrint = FormatterActions.FORMATTABLE_MEDIA_TYPES.includes(this.contentType) && !uiSourceCode.project().canSetFileContent() && Persistence.Persistence.PersistenceImpl.instance().binding(uiSourceCode) === null;
  ...
  allMessages() {
    const origins = this.persistenceBinding !== null ? [...this.persistenceBinding.network.messages(), ...this.persistenceBinding.fileSystem.messages()] : [...this.uiSourceCodeInternal.messages()];
