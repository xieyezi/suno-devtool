...
export class SourceFrameImpl extends Common.ObjectWrapper.eventMixin(UI.View.SimpleView) {
  constructor(lazyContent, options = {}) {
    ...
    Common.Settings.Settings.instance().moduleSetting("textEditorIndent").addChangeListener(this.#textEditorIndentChanged, this);
  }
  lazyContent;
  prettyInternal;
  rawContent;
  ...
  contentSet;
  disposeView() {
    Common.Settings.Settings.instance().moduleSetting("textEditorIndent").removeChangeListener(this.#textEditorIndentChanged, this);
  }
