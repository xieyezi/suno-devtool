...
export class ObjectPropertiesSection extends UI.TreeOutline.TreeOutlineInShadow {
  ...
  static assignWebIDLMetadata(value, properties) {
    ...
    const includedWebIdlProps = includedWebIdlTypes.flatMap((webIdlType2) => Object.entries(webIdlType2?.props ?? {}));
  ...
  static appendMemoryIcon(element, obj, expression) {
    ...
    memoryIcon.onclick = async (event) => {
      ...
      void controller.openInspectorView(obj, void 0, expression);
    };
...
export class ObjectPropertyTreeElement extends UI.TreeOutline.TreeElement {
  ...
  update() {
    ...
    if (isInternalEntries) {
      ...
      this.propertyValue = ObjectPropertiesSection.createPropertyValueWithCustomSupport(this.property.value, this.property.wasThrown, showPreview, this.listItemElement, this.linkifier, this.path());
