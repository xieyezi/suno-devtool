...
export class RemoteObjectPreviewFormatter {
  static objectPropertyComparator(a, b) {
    ...
    function sortValue(property) {
      ...
      if (property.name === InternalName.GeneratorState || property.name === InternalName.PrimitiveValue || property.name === InternalName.WeakRefTarget) {
        return 3;
      }
...
var InternalName = /* @__PURE__ */ ((InternalName2) => {
  ...
  InternalName2["WeakRefTarget"] = "[[WeakRefTarget]]";
