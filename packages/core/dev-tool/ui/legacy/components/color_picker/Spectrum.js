...
export class Spectrum extends Common.ObjectWrapper.eventMixin(UI.Widget.VBox) {
  ...
  updateInput() {
    if (this.colorFormat === Common.Color.Format.HEX || this.colorFormat === Common.Color.Format.ShortHEX || this.colorFormat === Common.Color.Format.Nickname) {
      ...
      if (this.colorFormat === Common.Color.Format.ShortHEX) {
        ...
        this.hexValue.value = String(this.color().asString(this.color().hasAlpha() ? Common.Color.Format.HEXA : Common.Color.Format.HEX));
      }
    } else {
  ...
  formatViewSwitch() {
    ...
    if (this.colorFormat === Common.Color.Format.RGB) {
      ...
      format = this.originalFormat === Common.Color.Format.ShortHEX || this.originalFormat === Common.Color.Format.ShortHEXA ? Common.Color.Format.ShortHEX : Common.Color.Format.HEX;
    }
  ...
  inputChanged(event) {
    ...
    let colorString;
    if (this.colorFormat === Common.Color.Format.Nickname || this.colorFormat === Common.Color.Format.HEX || this.colorFormat === Common.Color.Format.ShortHEX) {
