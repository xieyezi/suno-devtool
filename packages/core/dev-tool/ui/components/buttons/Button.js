...
export class Button extends HTMLElement {
  ...
  #render() {
    ...
    const classes = {
      ...
      small: Boolean(this.#props.size === "SMALL" /* SMALL */ || this.#props.size === "TINY" /* TINY */),
      tiny: Boolean(this.#props.size === "TINY" /* TINY */),
    ...
    LitHtml.render(LitHtml.html`
      ...
      width: this.#props.iconWidth || void 0,
      height: this.#props.iconHeight || void 0
    }}
          >
