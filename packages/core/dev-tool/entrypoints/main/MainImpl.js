...
export class MainImpl {
  ...
  #initializeExperiments() {
    ...
    Root.Runtime.experiments.register("fullAccessibilityTree", "Enable full accessibility tree view in the Elements panel", void 0, "https://developer.chrome.com/blog/new-in-devtools-90/#accesibility-tree", "https://g.co/devtools/a11y-tree-feedback");
    ...
    Root.Runtime.experiments.register("cssTypeComponentLength", "Enable CSS <length> authoring tool in the Styles pane", void 0, "https://developer.chrome.com/blog/new-in-devtools-96/#length", "https://g.co/devtools/length-feedback");
    ...
    Root.Runtime.experiments.register(Root.Runtime.ExperimentName.AUTHORED_DEPLOYED_GROUPING, "Group sources into Authored and Deployed trees", void 0, "https://goo.gle/authored-deployed", "https://goo.gle/authored-deployed-feedback");
    ...
    Root.Runtime.experiments.register(Root.Runtime.ExperimentName.DISABLE_COLOR_FORMAT_SETTING, "Disable the deprecated `Color format` setting (requires reloading DevTools)", false);
