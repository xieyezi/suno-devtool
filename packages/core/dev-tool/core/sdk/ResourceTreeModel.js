...
export class ResourceTreeModel extends SDKModel {
  ...
  async getStorageKeyData() {
    ...
    for (const { isMainFrame, storageKey } of await Promise.all([...this.framesInternal.values()].map((f) => f.getStorageKey(false).then((k) => ({
...
export var Events = /* @__PURE__ */ ((Events2) => {
  ...
  Events2["PrerenderAttemptCompleted"] = "PrerenderAttemptCompleted";
  return Events2;
})(Events || {});
