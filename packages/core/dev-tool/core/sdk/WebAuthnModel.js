...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["CredentialAdded"] = "CredentialAdded";
  Events2["CredentialAsserted"] = "CredentialAsserted";
  return Events2;
})(Events || {});
export class WebAuthnModel extends SDKModel {
  ...
  credentialAdded(params) {
    this.dispatchEventToListeners("CredentialAdded" /* CredentialAdded */, params);
  }
  credentialAsserted(params) {
    this.dispatchEventToListeners("CredentialAsserted" /* CredentialAsserted */, params);
  }
}
