...
export class TracingModel {
  ...
  addEvent(payload) {
    ...
    if (timestamp && timestamp < this.#minimumRecordTimeInternal && eventPhasesOfInterestForTraceBounds.has(payload.ph) && !payload.name.endsWith("::UMA")) {
...
export const eventPhasesOfInterestForTraceBounds = /* @__PURE__ */ new Set([
  "B" /* Begin */,
  "E" /* End */,
  "X" /* Complete */,
  "I" /* Instant */
