...
((MultitargetNetworkManager2) => {
  ...
  ((Events3) => {
    ...
    Events3["RequestFulfilled"] = "RequestFulfilled";
...
export class InterceptedRequest {
  ...
  static mergeSetCookieHeaders(originalSetCookieHeaders, setCookieHeadersFromOverrides) {
    const malformedHeaders = /* @__PURE__ */ new Set();
    const validHeaders = /* @__PURE__ */ new Map();
  ...
  async continueRequestWithContent(contentBlob, encoded, responseHeaders, isBodyOverridden) {
    ...
    MultitargetNetworkManager.instance().dispatchEventToListeners("RequestFulfilled" /* RequestFulfilled */, this.request.url);
