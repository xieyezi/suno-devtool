...
export class UserMetrics {
  ...
  breakpointWithConditionAdded(breakpointWithConditionAdded) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(EnumeratedHistogram.BreakpointWithConditionAdded, breakpointWithConditionAdded, BreakpointWithConditionAdded.MaxValue);
  }
  breakpointEditDialogRevealedFrom(breakpointEditDialogRevealedFrom) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(EnumeratedHistogram.BreakpointEditDialogRevealedFrom, breakpointEditDialogRevealedFrom, BreakpointEditDialogRevealedFrom.MaxValue);
  }
...
export var Action = /* @__PURE__ */ ((Action2) => {
  ...
  Action2[Action2["MaxValue"] = 60] = "MaxValue";
  return Action2;
})(Action || {});
export var PanelCodes = /* @__PURE__ */ ((PanelCodes2) => {
  ...
  PanelCodes2[PanelCodes2["MaxValue"] = 65] = "MaxValue";
  return PanelCodes2;
})(PanelCodes || {});
...
export var MediaTypes = /* @__PURE__ */ ((MediaTypes2) => {
  ...
  MediaTypes2[MediaTypes2["text/javascript"] = 1] = "text/javascript";
  ...
  MediaTypes2[MediaTypes2["MaxValue"] = 31] = "MaxValue";
  return MediaTypes2;
})(MediaTypes || {});
...
export var DevtoolsExperiments = /* @__PURE__ */ ((DevtoolsExperiments2) => {
  ...
  DevtoolsExperiments2[DevtoolsExperiments2["importantDOMProperties"] = 64] = "importantDOMProperties";
  DevtoolsExperiments2[DevtoolsExperiments2["justMyCode"] = 65] = "justMyCode";
  DevtoolsExperiments2[DevtoolsExperiments2["breakpointView"] = 66] = "breakpointView";
  DevtoolsExperiments2[DevtoolsExperiments2["timelineAsConsoleProfileResultPanel"] = 67] = "timelineAsConsoleProfileResultPanel";
  DevtoolsExperiments2[DevtoolsExperiments2["preloadingStatusPanel"] = 68] = "preloadingStatusPanel";
  DevtoolsExperiments2[DevtoolsExperiments2["disableColorFormatSetting"] = 69] = "disableColorFormatSetting";
  DevtoolsExperiments2[DevtoolsExperiments2["MaxValue"] = 70] = "MaxValue";
  return DevtoolsExperiments2;
})(DevtoolsExperiments || {});
export var BreakpointWithConditionAdded = /* @__PURE__ */ ((BreakpointWithConditionAdded2) => {
  BreakpointWithConditionAdded2[BreakpointWithConditionAdded2["Logpoint"] = 0] = "Logpoint";
  BreakpointWithConditionAdded2[BreakpointWithConditionAdded2["ConditionalBreakpoint"] = 1] = "ConditionalBreakpoint";
  BreakpointWithConditionAdded2[BreakpointWithConditionAdded2["MaxValue"] = 2] = "MaxValue";
  return BreakpointWithConditionAdded2;
})(BreakpointWithConditionAdded || {});
export var BreakpointEditDialogRevealedFrom = /* @__PURE__ */ ((BreakpointEditDialogRevealedFrom2) => {
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["BreakpointSidebarContextMenu"] = 0] = "BreakpointSidebarContextMenu";
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["BreakpointSidebarEditButton"] = 1] = "BreakpointSidebarEditButton";
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["BreakpointMarkerContextMenu"] = 2] = "BreakpointMarkerContextMenu";
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["LineGutterContextMenu"] = 3] = "LineGutterContextMenu";
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["KeyboardShortcut"] = 4] = "KeyboardShortcut";
  BreakpointEditDialogRevealedFrom2[BreakpointEditDialogRevealedFrom2["MaxValue"] = 5] = "MaxValue";
  return BreakpointEditDialogRevealedFrom2;
})(BreakpointEditDialogRevealedFrom || {});
...
export var RecordingExported = /* @__PURE__ */ ((RecordingExported2) => {
  ...
  RecordingExported2[RecordingExported2["ToLighthouse"] = 5] = "ToLighthouse";
  RecordingExported2[RecordingExported2["MaxValue"] = 6] = "MaxValue";
...
export var ManifestSectionCodes = /* @__PURE__ */ ((ManifestSectionCodes2) => {
  ...
  ManifestSectionCodes2[ManifestSectionCodes2["MaxValue"] = 5] = "MaxValue";
...
export var CSSHintType = /* @__PURE__ */ ((CSSHintType2) => {
  ...
  CSSHintType2[CSSHintType2["AlignContent"] = 1] = "AlignContent";
  CSSHintType2[CSSHintType2["FlexItem"] = 2] = "FlexItem";
  CSSHintType2[CSSHintType2["FlexContainer"] = 3] = "FlexContainer";
  CSSHintType2[CSSHintType2["GridContainer"] = 4] = "GridContainer";
  CSSHintType2[CSSHintType2["GridItem"] = 5] = "GridItem";
  CSSHintType2[CSSHintType2["FlexGrid"] = 6] = "FlexGrid";
  CSSHintType2[CSSHintType2["MulticolFlexGrid"] = 7] = "MulticolFlexGrid";
  CSSHintType2[CSSHintType2["Padding"] = 8] = "Padding";
  CSSHintType2[CSSHintType2["Position"] = 9] = "Position";
  CSSHintType2[CSSHintType2["ZIndex"] = 10] = "ZIndex";
  CSSHintType2[CSSHintType2["Sizing"] = 11] = "Sizing";
  CSSHintType2[CSSHintType2["FlexOrGridItem"] = 12] = "FlexOrGridItem";
  CSSHintType2[CSSHintType2["MaxValue"] = 13] = "MaxValue";
  return CSSHintType2;
})(CSSHintType || {});
export var LighthouseModeRun = /* @__PURE__ */ ((LighthouseModeRun2) => {
  ...
  LighthouseModeRun2[LighthouseModeRun2["LegacyNavigation"] = 3] = "LegacyNavigation";
  LighthouseModeRun2[LighthouseModeRun2["MaxValue"] = 4] = "MaxValue";
